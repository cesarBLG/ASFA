const int PAnPar = 37; //Pulsador anuncio parada
const int PAnPre = 33; //Pulsador anuncio precaucion
const int PPrePar = 41; //Pulsador preanuncio parada/via libre condicional
...
const int LuzAnPar = 47; //Luz pulsador anuncio parada
const int LuzAnPre = 51; //Luz pulsador anuncio precaucion
